...
// 배송조회결과 구함 (포스트박스편의점택배(CU,GS25))
function get_result_deliverytracking_postbox($content_temp) {                                 
    ...
    // (1) 송장번호
    $content_array3 =   explode("<th>송장번호</th>", $content_array2[0]);
    ...
    // (2) 이름
    $content_array3 =   explode("<th>이름</th>", $content_array2[0]);
    $content_array4 =   explode("</td>", $content_array3[1]);
    $content_array5 =   explode("<td>", $content_array4[0]);
    ...
    // (3) 접수일자
    $content_array3 =   explode("<th>접수일자</th>", $content_array2[0]);
    $content_array4 =   explode("</td>", $content_array3[1]);
    $content_array5 =   explode("<td>", $content_array4[0]);
    ...
    // (4) 접수시간
    $content_array3 =   explode("<th>접수시간</th>", $content_array2[0]);
    $content_array4 =   explode("</td>", $content_array3[1]);
    $content_array5 =   explode("<td>", $content_array4[0]);
    ...
    // (5) 점포명
    $content_array3 =   explode("<th>점포명</th>", $content_array2[0]);
    $content_array4 =   explode("</td>", $content_array3[1]);
    $content_array5 =   explode("<td>", $content_array4[0]);
    ...
    // (6) 구분
    $content_array3 =   explode("<th>구분</th>", $content_array2[0]);
    $content_array4 =   explode("</td>", $content_array3[1]);
    $content_array5 =   explode("<td>", $content_array4[0]);
    ...
    $result_deliverytracking  .=  "
        <table class=\"table table-bordered table-condensed table-hover\">
            ...
            <tbody>
                <tr>
                    <th class=\"active text-center\">송장번호</th>
    ...
    $content_array  =   explode("<caption>배송조회 결과</caption>", $content_temp);
    $content_array2 =   explode("</table>", $content_array[1]);            
