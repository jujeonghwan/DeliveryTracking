...
function get_result_deliverytracking_doortodoor($content_temp) {                                 
	...
	*/
    ...
    for ($i = 1; $i < $content_array4_count; $i++) {                    // 1~
        ...
        // (4) 담당 점소
        $content_array6 =   explode("<td class=\"", $content_array5[0]);
        $content_array7 =   explode("title=\"영업소 정보 팝업\">", $content_array6[4]);            // 4
    ...
    */
    ...
    // (1) 택배사원
    $content_array3 =   explode("<th scope=\"col\">택배사원</th>", $content_array2[0]);
    $content_array4 =   explode("</td>", $content_array3[1]);
    ...
    $result_deliverytracking  .=  "
        <table class=\"table table-bordered table-condensed table-hover\">
            ...
            <thead>
                <tr class=\"active\">
                    <th class=\"text-center\" colspan=\"5\">택배사원 정보</th>          
                </tr>
                <tr class=\"active\">
                    <th class=\"text-center\">택배사원</th>
