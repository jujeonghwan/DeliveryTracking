...
function get_result_deliverytracking_hdexp($content_temp) {                                 
    ...
    */
    ...
    /*
    <iframe src="https://hdexp.co.kr/basic_delivery.hd?barcode=3132062290287" width="500px" height="500px" seamless="seamless"></iframe>
    */
    ...
    // (1) 운송장번호
    $content_array  =   explode("https://hdexp.co.kr/basic_delivery.hd?barcode=", $content_temp);
...
// 배송조회결과 구함 (합동택배)
function get_result_deliverytracking_hdexp_20190601($content_temp) {                                 
